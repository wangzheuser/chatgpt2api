...
function normalizeConfig(config: SettingsConfig): SettingsConfig {
  ...
  return {
    ...
    default_upstream_model_name: String(config.default_upstream_model_name || "").trim() || "gpt-5-6",
  ...
  saveConfig: async () => {
    ...
    try {
      const data = await updateSettingsConfig({
        ...
        default_upstream_model_name: String(config.default_upstream_model_name || "gpt-5-6").trim() || "gpt-5-6",
